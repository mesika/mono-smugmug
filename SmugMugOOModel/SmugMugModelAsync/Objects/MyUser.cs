...
namespace SmugMugModel
{
    public class MyUser : SmugMugObject
    {
        ...
        public async Task<bool> LogoutAsync()
        {
            ...
            var resp = await ch.ExecuteMethod<SmugMugResponse>("smugmug.logout", basic);
            if (resp.stat == "ok")
                return true;
            else
            {
        ...
        // {
        //     CommunicationHelper ch = new CommunicationHelper();
        //     var resp = await ch.ExecuteMethod<CommunityResponse>("smugmug.communities.getAvailable", basic);
        //     if (resp.stat == "ok")
        //     {
        //         var temp = new List<Community>();
        //         temp.AddRange(resp.Communities);
        ...
        //{
        //    CommunicationHelper ch = new CommunicationHelper();
        //    var resp = await ch.ExecuteMethod<CommunityResponse>("smugmug.communities.leaveAll", basic);
        //    if (resp.stat == "ok")
        //    {
        //        return true;
        //    }
